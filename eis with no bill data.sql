...
ddo.hierarchy_Code,
concat(a.gpf_or_ppan_no,'') Employee_id, 
CONCAT(ifnull(a.emp_First_Name,''),' ',ifnull(a.emp_last_Name,'') ) Employee_Name,
a.dob, a.appoin_Date, a.retirement_date, a.retirement_age, a.pan_No, a.marital_Status, a.spouse_Name,
bbb.mmonth
