SELECT hr.hierarchy_Code, hr.hierarchy_Name, h.head,
		...
		h.voted_charged_status,date(le.expenditure_date) dt, 
		...
		AND h.head LIKE '2245-02-122-0999%'
		...
		ELSE 'EE'
		END ,h.ga_ssa_status,
		h.voted_charged_status, date(le.expenditure_date),b.bill_number, b.bill_date
