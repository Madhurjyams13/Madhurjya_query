...
SUM(CASE WHEN cm.component_code = 'AGMCA' THEN com.amount ELSE 0 END) AS 'Motor Car advance',
...
SUM(CASE WHEN cm.component_code = 'AIFS' THEN com.amount ELSE 0 END) AS 'AIS Refund',
