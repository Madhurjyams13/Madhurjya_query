SELECT try.hierarchy_Code, try.hierarchy_Name, ddo.hierarchy_Code,
a.token_number, a.bill_number, a.bill_date, a.bill_pf_type,
a.total_allowance bill_gross, a.total_deduction bill_deduction, 
...
SUM(CASE WHEN cm.component_code = 'DA' THEN com.amount ELSE 0 END) AS 'Dearness Allowance',
...
SUM(CASE WHEN cm.component_code = 'GP' THEN com.amount ELSE 0 END) AS 'Grade Pay',
...
SUM(CASE WHEN cm.component_code = 'HR' THEN com.amount ELSE 0 END) AS 'House Rent',
...
SUM(CASE WHEN cm.component_code = 'LTC' THEN com.amount ELSE 0 END) AS 'Leave Travel Concession',
SUM(CASE WHEN cm.component_code = 'MA' THEN com.amount ELSE 0 END) AS 'Medical Allowance',
